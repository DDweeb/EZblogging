        ...
        <div className="flex justify-center w-full pt-8">
            <div className="max-w-screen-lg w-full">
                ...
                <button onClick={async () => {
                    ...
                    setLoading(false)
                    navigate(`/getOneBlog/${response.data.postId}`)

                }}
                    type="submit" className="inline-flex items-center mt-4 px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark: focus:ring-blue-900 hover:bg-blue-800">
                    Publish post
                </button>
            </div>
        </div>
...
function Loader() {
    return (
        ...
        <div role="status" className="flex justify-center flex-col h-screen ">
